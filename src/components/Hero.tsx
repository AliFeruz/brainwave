    ...
    id="hero">
      <div className="container relative" ref={parallaxRef}>
        ...
        mb-[4rem] md:mb-20 lg:mb-[6rem]">
            <h1 className="h1 mb-6"> Explore the Possibilities of 
            &nbsp;AI&nbsp; Chatting with {''}<span className="inline-block relative">Brainwave{''}
            <img src={curve} className="absolute top-full left-0 w-full xl:-mt-2" 
            width={624} height={28} alt="Curve"/>
            </span></h1>
            <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">Unleash the power of &nbsp;AI&nbsp; within 
            Brainwave. Upgrade your productivity with Brainwave, 
            the open AI chat app.</p>
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-22">
            ...
            <div className="relative bg-n-8 rounded-[1rem]">
                ...
                width={1024} height={490} alt="Hero"/>
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <ul className="hidden absolute -left-[5.5rem] bottom-[7.5rem] p-1 bg-n-9/40
            ...
            md:-top-[46%] md:w-[138%] lg:-top-[104%]">
                <img src={heroBackground} width={1440} height={1800}
                 alt="herobackground" className="w-full"/>
            </div>
