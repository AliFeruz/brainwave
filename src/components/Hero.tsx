    ...
    id="hero">
      <div className="container relative">
        ...
        mb-[4rem] md:mb-20 lg:mb-[6rem]">
            <h1 className="h1 mb-6"> Explore the Possibilites of 
            AI Chatting with BrainwaveCurve <span className="inline-block relative">Brainwave{''}
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-22">
            ...
            <div className="relative bg-n-8 rounded-[1rem]">
                ...
                <img src={robot} className="w-full" width={1024} height={490} alt="Hero"/>
                </div>
            </div>
            </div>
