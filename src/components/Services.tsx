    ...
    <div className="relative">
        ...
        <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
            ...
            bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                ...
                <p className="body-2 mb-[3rem] text-n-3">Automatically enhance your photos using our 
                AI app's photo editing feature. Try it now!</p>
            </div>
            <PhotChatMessage/>
        </div>
        <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
            <div className="py-12 px-4 xl:px-8">
                ...
                <p className="body-2 mb-[2rem] text-n-3">The world’s most powerful AI photo and video art 
                generation engine. What will you create?</p>
                <ul className="flex items-center justify-between">
                    {brainwaveServicesIcons.map((icon, index) => (
                        ...
                        ${index === 2 ? 'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]' : 'flex w-10 h-10 bg-n-6 md:w-15 md:h-15'}`}>
                            ...
                            <img src={icon} alt="icons" width={24} height={24} />
                            </div>
                        </li>
                    ))}
                </ul>
            ...
            <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                <img src={service3} alt="picture" width={520} height={400}
